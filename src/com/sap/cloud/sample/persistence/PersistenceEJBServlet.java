...
public class PersistenceEJBServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		money.setMoney(1234);
		System.out.println("This is in get / servelet " + money.getMoney());
		request.getSession(true);
		response.getWriter().println("<a href=\"MoneyServlet\">You have to push hear to view how much money do you have !!!</a>");
